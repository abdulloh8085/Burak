...
Monorepo project: API & BATCH & CRAWLING
DEVOPS:
VPS Linux Ubuntu NGINX Firewall UFW Docker Docker-Compose PM2 Grafana
TOOLS:
Postman Yarn nvm npm SSH SFTP Git GitHub
MongoDB Compass Apollo Playground
...
Socket.Io-Client React-Router-Dom Swiper
BACKEND:
Python RestAPI Django FastAPI MySql PyMango
Session & Token Authentication Bcrypt Python-SocketIO
Cookie-Parser JWT DotEnv Form-Data
Patterns: MVC Middleware Dependency Injection
Monorepo project: API & BATCH & CRAWLING
DEVOPS:
VPS Linux Ubuntu NGINX Firewall UFW Docker Docker-Compose Grafana
TOOLS:
Postman Yarn nvm npm SSH SFTP Git GitHub
